...
public interface CourseService {
    ...
    Page<UserDto> findInternsByCourse(Long courseId, PageRequest pageRequest);

    List<UserDto> findMentorsByCourse(Long courseId);

    UserIdsRequest unassignUsers(Long courseId, UserIdsRequest requestBody);
}
